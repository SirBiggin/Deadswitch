      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Card(child: Padding(
            padding: const EdgeInsets.all(16),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Send a test message directly from this phone\'s SIM.',
                  style: TextStyle(color: Colors.grey, fontSize: 12)),
              const SizedBox(height: 12),
          ...
          Card(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _infoRow('SMS', 'Native SIM'),
              const SizedBox(height: 8),
              const Text(
                'Messages send directly from this phone\'s SIM card via Android SmsManager. '
                'Multiple recipients per message are sent as a group MMS.',
                style: TextStyle(color: Colors.grey, fontSize: 12)),
            ]),
          )),
        ]),
